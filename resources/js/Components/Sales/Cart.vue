    ...
    <AppLayout>
        <div class="h-full flex gap-4 p-4 bg-slate-50">
            ...
            <div class="flex-1 bg-white rounded-3xl shadow-lg flex flex-col overflow-hidden">
                ...
                <div class="p-6 border-b border-slate-100 bg-gradient-to-r from-amber-50 to-white">
                    <div class="flex flex-wrap items-center gap-4">
                        <div class="flex-1 min-w-[200px]">
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    class="w-full rounded-2xl border-slate-200 bg-white pl-12 pr-4 py-3.5 text-base outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent shadow-sm"
                                />
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            class="px-5 py-3 rounded-2xl bg-amber-100 text-amber-700 hover:bg-amber-200 transition font-medium flex items-center gap-2"
                        >
                ...
                <div class="flex-1 overflow-y-auto p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                        <div
                            ...
                            class="group cursor-pointer bg-white rounded-2xl border border-slate-200 p-4 transition-all hover:shadow-xl hover:border-amber-300 hover:-translate-y-1"
                        >
                            <div class="aspect-square w-full rounded-2xl bg-gradient-to-br from-amber-50 to-slate-100 flex items-center justify-center overflow-hidden mb-3">
                                <img
                                    v-if="product.image"
                                    :src="product.image"
                                    :alt="product.name"
                            ...
                            <div class="text-center">
                                ...
                                <div class="mt-3 opacity-0 group-hover:opacity-100 transition">
                                    <span class="inline-block w-full py-2 rounded-xl bg-amber-600 text-white text-sm font-semibold hover:bg-amber-700 transition">
                                        Agregar
                                    </span>
                                </div>
                            </div>
            ...
            <div class="w-[420px] bg-white rounded-3xl shadow-lg flex flex-col relative">
                ...
                <!-- Header del carrito -->
                <div class="p-6 border-b border-slate-100 bg-gradient-to-r from-amber-50 to-white flex-shrink-0">
                ...
                <div class="flex-1 overflow-y-auto p-4 space-y-3 pb-36">
                    ...
                    <div
                        ...
                        :key="item.id"
                        class="bg-slate-50 rounded-2xl p-4 border border-slate-200 hover:border-amber-200 transition"
                    >
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <button
                                    @click="increase(item)"
                                    class="h-8 w-8 rounded-xl bg-amber-500 hover:bg-amber-600 transition flex items-center justify-center font-bold text-white"
                                >
                                    +
                                </button>
                            </div>
                ...
                <div class="absolute bottom-0 left-0 right-0 p-6 bg-white border-t border-slate-200 rounded-b-3xl shadow-lg">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <span class="text-2xl font-bold text-amber-600">{{ formatCurrency(cart.grandTotal.value) }}</span>
                    </div>
